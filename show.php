...
<head>
    <?php
    include("conn.php");
    // session_start;  // เริ่มใช้างานตัวแปร Session
     include("clogin.php"); //เช็คว่าเขาต้องเข้าหน้าlogin ก่อนถึงหน่วยงาน
...
<body>
    ...
    <h2> ชื่อผู้เข้าสู่ระบบ : <?php echo $_SESSION["u_name"]; ?> หน่วยงาน : <?php echo $_SESSION["u_department"]; ?> </h2>
    ...
    <h2>พัฒนาโดย 664485036 นาย ฑีฆายุ เปรมสุข  </h2>
</body>
